...
public class Configuration {
  ...
  public ResultSetHandler newResultSetHandler(Executor executor, MappedStatement mappedStatement, org.apache.ibatis.session.RowBounds rowBounds, ParameterHandler parameterHandler,
                                              org.apache.ibatis.session.ResultHandler resultHandler, BoundSql boundSql) {
    ResultSetHandler resultSetHandler = new DefaultResultSetHandler(executor, mappedStatement, parameterHandler, resultHandler, boundSql, rowBounds);
    resultSetHandler = (ResultSetHandler) interceptorChain.pluginAll(resultSetHandler);
    return resultSetHandler;
  }

  public StatementHandler newStatementHandler(Executor executor, MappedStatement mappedStatement, Object parameterObject, org.apache.ibatis.session.RowBounds rowBounds, org.apache.ibatis.session.ResultHandler resultHandler, BoundSql boundSql) {
  ...
  public Executor newExecutor(Transaction transaction, org.apache.ibatis.session.ExecutorType executorType) {
    ...
    executorType = executorType == null ? org.apache.ibatis.session.ExecutorType.SIMPLE : executorType;
    Executor executor;
    if (org.apache.ibatis.session.ExecutorType.BATCH == executorType) {
      executor = new BatchExecutor(this, transaction);
    } else if (org.apache.ibatis.session.ExecutorType.REUSE == executorType) {
